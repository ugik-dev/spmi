...
<button type="button" class="btn btn-sm btn-success temporary-edit mb-2 mt-2 approval_btn_treasurer" data-res="Y">
    <i data-feather="file-text"></i> Terima
</button>

<button type="button" class="btn btn-sm btn-danger temporary-edit mb-2 mt-2 approval_btn_treasurer" data-res="N">
    <i data-feather="file-text"></i> Tolak
</button>

<script>
    document.addEventListener('DOMContentLoaded', function() {
        $('.approval_btn_treasurer').on('click', function(e) {
            e.preventDefault();
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        url: '{{ route('receipt-action.treasurer', $receipt) }}',
                        type: 'POST',
                        headers: {
