                        ...
                        <div class="statbox widget box box-shadow">
                            <div style="min-height:50vh;" class="widget-content widget-content-area">
                                ...
                                <div class="d-flex justify-content-center justify-content-md-start">
                                    ...
                                    <button type="button" class="btn btn-primary btn-md w-20 ms-md-4" data-bs-toggle="modal" data-bs-target="#exampleModalCenter">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center ">
                                                    <button type="button" class="btn btn-sm btn-primary" onclick="openEditModal({{ $expenditureUnit->id }}, '{{ $expenditureUnit->name }}', '{{ $expenditureUnit->code }}')">
                                                        <i class="text-white" data-feather="edit-2"></i>
                                                    </button>

                                                    <a href="javascript:void(0);" class="btn btn-danger btn-sm" role="button" onclick="confirmDelete({{ $expenditureUnit->id }});">
                                                        <i class="text-white" data-feather="trash-2"></i>
                                                    </a>
                                                    <!-- Hidden form for delete request -->
                                                    <form id="delete-form-{{ $expenditureUnit->id }}" action="{{ route('expenditure_unit.delete', $expenditureUnit->id) }}" method="POST" style="display: none;">
                                                        @csrf
                                                        @method('DELETE')
                                                    </form>
                            ...
                            <div class="modal-body">
                                <form id="edit-form" action="" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="expenditure_unit_name" name="name" class="form-control" required>
                                    </div>
                                    <div class="form-group mt-3">
                                        <label>Kode</label>
                                        <input type="text" id="expenditure_unit_code" name="code" class="form-control" required>
                                    </div>
