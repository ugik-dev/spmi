                                        ...
                                        <td class="align-middle">
                                            <div class="d-flex justify-content-center align-items-center">
                                                ...
                                                <form id="delete-form-{{ $accountCode->id }}"
                                                    action="{{ route('account_code_reception.delete', $accountCode->id) }}"
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalCenterTitle">Input Kode Akun Penerimaan</h5>
                    ...
                    "buttons": [{
                            ...
                            action: function(e, dt, node, config) {
                                window.location.href =
                                    "{{ route('download.account.code.reception.pdf') }}";
                            }
                        },
                        {
                            extend: 'excel',
